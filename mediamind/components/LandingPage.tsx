    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-900 text-white">
      ...
      <div className="container mx-auto px-4 py-10 md:py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Stats */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 max-w-2xl mx-auto mb-10 md:mb-20">
      ...
      {/* Features Section */}
      <div id="features" className="bg-white/5 backdrop-blur-sm py-10 md:py-20">
      ...
      {/* Benefits */}
      <div className="bg-white/5 backdrop-blur-sm py-10 md:py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
      ...
      {/* CTA Section */}
      <div className="container mx-auto px-4 py-10 md:py-20">
        <div className="max-w-3xl mx-auto text-center bg-white/10 backdrop-blur-sm rounded-3xl p-6 md:p-12 border border-white/20">
          <h3 className="text-3xl md:text-4xl font-bold mb-4">Ready to Transform Your Content?</h3>
